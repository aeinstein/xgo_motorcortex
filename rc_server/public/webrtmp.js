...
class WebRTMP_Controller {
	...
	receiveVideo(enable){
		this.WebRTMPWorker.postMessage({cmd: "receiveVideo", enable: enable});
	}

	receiveAudio(enable){
		this.WebRTMPWorker.postMessage({cmd: "receiveAudio", enable: enable});
	}
...
class WebRTMP{
	...
	receiveVideo(enable){
		this.wss.receiveVideo(enable);
	}

	receiveAudio(enable){
		this.wss.receiveAudio(enable);
	}
