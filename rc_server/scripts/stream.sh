...
ffmpeg -f rawvideo -vcodec rawvideo -s 640x480 -r 30 -pix_fmt yuv420p -rtbufsize 1M -i - -f pulse -i default \
...
-vcodec libx264 -b:v 2M -s 640x480 -preset ultrafast -profile:v main -x264-params keyint=30:scenecut=0 -acodec aac -ac 1 -ar 44100 -shortest -f flv rtmp://127.0.0.1/demo/live
